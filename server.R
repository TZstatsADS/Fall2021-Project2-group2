...
server <- 
  function(input, output, session) {
    ...
    NYC_Dog_Licensing_Dataset2 <- count(NYC_Dog_Licensing_Dataset, "LicenseIssuedDate")
    
    colnames(NYC_Dog_Licensing_Dataset2) <- c("date", "freq") 
    #Standardize date format
    NYC_Dog_Licensing_Dataset2 <- NYC_Dog_Licensing_Dataset2 %>% mutate(date = mdy(date))
    ...
    output$dogRecentTotals <- renderValueBox({
      valueBox(
        value =  paste0("+",
                        round(((sum(NYC_Dog_Licensing_Dataset2[NYC_Dog_Licensing_Dataset2$date >= "2020-07-20" & NYC_Dog_Licensing_Dataset2$date <= "2020-12-31",]$freq)-
                                  sum(NYC_Dog_Licensing_Dataset2[NYC_Dog_Licensing_Dataset2$date >= "2019-07-20" & NYC_Dog_Licensing_Dataset2$date <= "2019-12-31",]$freq))/
                                 sum(NYC_Dog_Licensing_Dataset2[NYC_Dog_Licensing_Dataset2$date >= "2019-07-20" & NYC_Dog_Licensing_Dataset2$date <= "2019-12-31",]$freq)*100),
                              digits=2),"%"
        ),
    ...
    output$dogPercDiff <- renderValueBox({
      valueBox(
        value =  paste0("+",
                        (sum(NYC_Dog_Licensing_Dataset2[NYC_Dog_Licensing_Dataset2$date >= "2020-07-20" & NYC_Dog_Licensing_Dataset2$date <= "2020-12-31",]$freq)-
                           sum(NYC_Dog_Licensing_Dataset2[NYC_Dog_Licensing_Dataset2$date >= "2019-07-20" & NYC_Dog_Licensing_Dataset2$date <= "2019-12-31",]$freq))
